...
<?php
	...
	<tr>
		...
		<td><?= $dta['namaguru'] ?></td>
		<td width="160px">
			<a class="btn btn-warning btn-sm" href="editWaliKelas.php?kls=<?= $dta['kelas'] ?>">EDIT</a> 
			<a class="btn btn-danger btn-sm" href="hapusWaliKelas.php?kls=<?= $dta['kelas'] ?>"onclick="return confirm('apakah anda yakin menghapus data?')">HAPUS</a>
		</td>
	</tr>
	<?php $i++ ; ?>
<?php endwhile; ?>
